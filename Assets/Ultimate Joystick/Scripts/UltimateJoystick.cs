...
public class UltimateJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
	...
	public enum Anchor{ Left, Middle, Right }
	...
	public float touchScaleModifier = 1.1f;
	public float touchScaleDuration = 0.25f, releaseScaleDuration = 1.0f;
	...
	public void OnPointerDown ( PointerEventData touchInfo )
	{
		...
		// EDIT: Check if this is actually working.
		touchInfo.Use();
	...
	Vector2 ConfigureImagePosition ( Vector2 textureSize, Vector2 customSpacing )
	{
        ...
        switch (anchor)
        {
            case Anchor.Left:
                ...
                tempVector.x = positionSpacerX;

                break;

            case Anchor.Middle:

                tempVector.x = Screen.width / 2f - textureSize.x / 2f;
            ...
            default:
                ...
                tempVector.x = (Screen.width - textureSize.x) - positionSpacerX;
