...
namespace Watermelon
{
    ...
    public class DiagonalProjectileAbility : Ability, IProjectileAmountAbility
    {
        public DiagonalProjectileAbilityData data;

        private static Quaternion rightRotation = Quaternion.Euler(0, 45, 0);
        private static Quaternion leftRotation = Quaternion.Euler(0, -45, 0);
