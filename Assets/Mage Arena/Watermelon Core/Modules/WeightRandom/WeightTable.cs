...
namespace Watermelon
{
    ...
    /// </summary>
    public class WeightTable : IWeightTable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WeightTable"/> class.
        /// </summary>
        public WeightTable() : this(null, 1)
        {
        }
        ...
        public WeightTable(IEnumerable<IWeightObject> contents, int count)
        {
            if (contents != null)
        ...
        private List<IWeightObject> contents = null;
        ...
        public virtual IEnumerable<IWeightObject> result
        {
            get
            {
                ...
                foreach (IWeightObject o in contents)
                ...
                foreach (IWeightObject o in contents.Where(e => e.DropAlways && e.IsEnabled))
                    AddToResult(rv, o);
                ...
                int alwayscnt = contents.Count(e => e.DropAlways && e.IsEnabled);
                ...
                if (realdropcnt > 0)
                {
                    for (int dropcount = 0; dropcount < realdropcnt; dropcount++)
                    {
                        ...
                        IEnumerable<IWeightObject> dropables = contents.Where(e => e.IsEnabled && !e.DropAlways);
