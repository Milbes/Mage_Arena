...
namespace Watermelon
{
    ...
    /// </summary>
    public class WeightCreatableObject : WeightObject, IWeightObjectCreator
    {
        /// <summary>
        ...
        public virtual IWeightObject CreateInstance()
        {
            return (IWeightObject)Activator.CreateInstance(this.GetType());
        }
    }
}