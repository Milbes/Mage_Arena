...
{
    [System.Serializable]
    public class LootObject : IWeightObject, ICloneable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WeightObject"/> class.
        /// </summary>
        public LootObject() : this(0)
        { }
        ...
        public LootObject(float probability) : this(probability, true, false, true)
        { }
        ...
        public LootObject(float probability, bool unique, bool always, bool enabled)
        {
